...
/// separate from ModelMetadata, which only stores aggregate counts (specs/13). Used
/// solely to render the PNG companion map image; never persisted.
/// </summary>
...
public static class NetworkGraphExtractor
{
    ...
    /// <summary>Returns null if the format/content isn't recognized — caller skips PNG generation.</summary>
